window.addEventListener("DOMContentLoaded", (event) => {
		...
		TCNDDF.setup = function () {
			...
			if (persistantStorage) {
				displayContainer.addEventListener(
					"keyup",
					function () {
						contentStorageTimer = setTimeout(
							"TCNDDF.writeContentEdits('mainContent')",
							1000
						);
					},
					false
	...
	*/
		...
		// 	console.log(
		// 		"Cache has been updated due to a change found in the manifest"
		// 	);
		// };
		// TCNDDF.errorCache = function () {
		// 	console.log(
		// 		"You're either offline or something has gone horribly wrong."
		// 	);
		// };
